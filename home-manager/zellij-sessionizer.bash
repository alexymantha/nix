...
###
### Modified version of zellij-sessionizer from https://github.com/victor-falcon/zellij-sessionizer
###

SEARCH_PATHS=(${ZELLIJ_SESSIONIZER_SEARCH_PATHS:-"$HOME/dev"})
SPECIFIC_PATHS=(${ZELLIJ_SESSIONIZER_SPECIFIC_PATHS:-"$HOME/nix"})
# Even on MacOS, we override stat to use the same as linux
OS_TYPE="${ZELLIJ_SESSIONIZER_OS_TYPE:-"Linux"}"
ZELLIJ_SWITCH_PLUGIN="${ZELLIJ_SESSIONIZER_SWITCH_PLUGIN:-"file:$(which zellij-switch.wasm)"}"
